...
import React, {
  ...
  import { registerLoader } from "../lib/loaderController";
  ...
  export const LoaderProvider: React.FC<{ children: React.ReactNode }> = ({
    ...
    // 🔑 Register loader globally (Firestore & other services)
    useEffect(() => {
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="relative w-24 h-24">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-28 h-28 border-4 border-t-primary-500 border-b-primary-200 rounded-full animate-spin" />
                </div>
              </div>
